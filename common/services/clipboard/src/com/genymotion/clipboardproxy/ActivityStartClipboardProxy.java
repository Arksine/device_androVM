...
public class ActivityStartClipboardProxy extends Activity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Stop button
		btn = (Button) findViewById(R.id.broadcast);
		btn.setOnClickListener(this);
	}
	...
	public void onClick(View v) {
		...
		Intent clipboardProxyIntent = new Intent(this,
				ServiceClipboardProxy.class);
		...
		if (v.getId() == R.id.start_service) {
			...
			sendBroadcast(new Intent("com.genymotion.clipboardproxy.CLIP_CHANGED"));
		}
	}
